<div>
    <header class="bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-800 dark:to-blue-950 text-white py-16 sm:py-24 md:py-32" data-aos="fade-up">
        <div class="max-w-6xl mx-auto px-4 text-center">
            ...
            <p class="text-lg sm:text-xl font-light opacity-80 max-w-2xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="200">
                Buat dan bagikan vote online dengan mudah, atau ikuti vote dengan memasukkan token.
            </p>
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4" data-aos="fade-up" data-aos-delay="400">
    ...
    <main id="fitur" class="max-w-6xl mx-auto p-4 sm:p-8 md:p-12">
        <section class="text-center my-12 md:my-20" data-aos="fade-up">
            <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6">Fitur Unggulan Kami</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105" data-aos="flip-left">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105" data-aos="flip-up" data-aos-delay="200">
                    <div class="text-blue-600 dark:text-blue-400 mb-4">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg transform transition duration-300 hover:scale-105" data-aos="flip-right" data-aos-delay="400">
                    <div class="text-blue-600 dark:text-blue-400 mb-4">
        ...
        <section id="ikuti-vote" class="bg-blue-50 dark:bg-gray-800 p-6 sm:p-8 md:p-10 rounded-lg shadow-lg my-12" data-aos="fade-right">
            <div class="text-center">
                ...
                <a href="{{ route('voter.login') }}" class="w-full sm:w-auto px-8 py-3 bg-blue-600 text-white font-semibold rounded-full shadow-lg hover:bg-blue-700 transition duration-300" data-aos="zoom-in">
                    Ikuti Vote
                </a>
            </div>
        </section>
    
        <section class="text-center my-12 md:my-20" data-aos="zoom-in-up">
            ...
            <a href="/admin/polls" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300 transform hover:scale-105" data-aos="fade-up" data-aos-delay="200">
                Buat Vote Sekarang
            </a>
        </section>
    </main>
